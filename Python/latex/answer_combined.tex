...
\titlespacing{\section}
  {0pt}{30pt plus 10pt minus 5pt}{15pt}

\begin{document}

\title{\Huge 🌌 Galaxy Quiz -- Cosmic Timeline Edition}
\author{}
\date{}
\maketitle
...
\begin{enumerate}[label=\Alph*.]
    \item \textbf{\textcolor{correct}{$\sim$100 Myr ✅}}
    \item $\sim$1 Gyr
    \item $\sim$10 Gyr
    \item $\sim$10 Myr
\end{enumerate}
\textit{Explanation: Massive stars have lifetimes on the order of $\sim$100 million years.}
\bigskip
